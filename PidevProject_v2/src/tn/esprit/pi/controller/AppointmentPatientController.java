...
public class AppointmentPatientController implements Initializable {
    ...
    private boolean verifHHMM(String hh, String mm) {
        ...
        alert.setContentText("Les heures et les minutes doivent être des nombres");
        alert.showAndWait();
        return false;
        }
        ...
        alert.setTitle("Erreur");
        alert.setHeaderText(null);
        alert.setContentText("Les heures et les minutes doivent être composées de 1 ou 2 chiffres");
        alert.showAndWait();
            return false;
        }
    ...
    private boolean isNumber(String chaine){
        ...
        for (int i = 0; i < chaine.length(); i++) {
            if (!Character.isDigit(chaine.charAt(i))) {
                ...
                alert.setTitle("Erreur");
                alert.setHeaderText(null);
                alert.setContentText("Les heures doivent être entre 0 et 23 et les minutes doivent être entre 0 et 59");
                alert.showAndWait();
                return false;
            }
        }
    ...
    private void addClicked(MouseEvent event) throws SQLException, ParseException {
        ...
        if(dateNow.before(dateRDV))
        {
            ...
            Sa.add(a);
            // Ajouter l'alerte de succès ici
